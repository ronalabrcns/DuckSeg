...
def pad_then_transform_2d(image, padding, shift0, shift1, rotation):
    padded = np.pad(array, pad_width=padding, mode='constant', constant_values=0)
    return transform_2d(image, shift0, shift1, rotation)
...
# make sure transform_2d does not push things out of boundaries
# add base to rotation_range and translation_range
# correlate with first frame, try in ranges with base as the last resul
